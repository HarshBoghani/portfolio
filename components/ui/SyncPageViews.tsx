...
export default function SyncPageViews() {
  ...
  useEffect(() => {
    ...
    async function incrementAndFetch() {
      try {
        const res = await fetch('/api/sync/increment', { method: 'POST' });
  ...
  return (
    <span className="font-mono text-xs text-neutral-600 dark:text-neutral-500">
